 ...
 */
final class Version20230425210030 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comments CHANGE commentaire commentaire VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE comments ADD CONSTRAINT FK_5F9E962AC1B77974 FOREIGN KEY (entreprise_partenaire_id) REFERENCES entreprise_partenaire (id)');
        $this->addSql('CREATE INDEX IDX_5F9E962AC1B77974 ON comments (entreprise_partenaire_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comments DROP FOREIGN KEY FK_5F9E962AC1B77974');
        $this->addSql('DROP INDEX IDX_5F9E962AC1B77974 ON comments');
        $this->addSql('ALTER TABLE comments CHANGE commentaire commentaire LONGTEXT NOT NULL');
    }
}
